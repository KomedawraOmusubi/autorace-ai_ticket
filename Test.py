...
HANDE_CONFIG = {
    0:   {'x': 175, 'y': 400, 'angle': 0.0},   # ★0mは垂直
    10:  {'x': 125, 'y': 370, 'angle': -1.1},  
    20:  {'x': 100, 'y': 345, 'angle': -1.2}, 
    30:  {'x': 75,  'y': 315, 'angle': -0.8}, 
    40:  {'x': 60,  'y': 280, 'angle': -0.6}, 
    50:  {'x': 50,  'y': 240, 'angle': -0.4}, 
    60:  {'x': 45,  'y': 200, 'angle': -0.5},  
    70:  {'x': 42,  'y': 175, 'angle': 0.5}, 
    80:  {'x': 60,  'y': 125, 'angle': 0.4}, 
    90:  {'x': 78,  'y': 95, 'angle': 0.4}, 
    100: {'x': 76,  'y': 65,  'angle': 0.3},  # ★100mは角度あり
}
