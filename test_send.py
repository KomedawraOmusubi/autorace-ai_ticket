...
test_positions = [
    ...
    {'car': 2, 'x': 230 - 90,        'y': 480}, # 1個左へ
    {'car': 3, 'x': 260 - 90,        'y': 520}, # 1個左へ
    {'car': 4, 'x': 290 - (30 * 5),  'y': 560}, # 2個左へ
    {'car': 5, 'x': 320 - (30 * 5),  'y': 600}, # 2個左へ
    {'car': 6, 'x': 350 - (30 * 5),  'y': 640}, # 2個左へ
    {'car': 7, 'x': 380 - (30 * 8),  'y': 680}, # 3個左へ
    {'car': 8, 'x': 410 - (30 * 8),  'y': 720}, # 3個左へ
]
